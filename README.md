...
NOTE: This fork is maintained by Gateless, opinionated modifications have been made
to the original library. Please see the "Rationale" section below for more details.

## Support this library

This library is fueled by dopamine hits generated by positive feedback.
Show your support by "starring" the project. You can also DM me on the Clojurians Slack
with your tales of how this library has been helpful to you.

## Rationale

Gateless maintains this fork of clj-pool-party to better suit our needs, it changes `with-object`
to a macro to better support borrowing objects from the pool within an async or go block using
virtual threads without having to cross the function boundary.
...
pool and for all of my use cases, there exists a reasonable upper bound to the size of the object pool.
...
This library hasn't seen any activity since January 2019.
...
`build-pool`, `evict-all` and `with-object`, are the important functions and macro.
...
;;execute an arbitrary body in the context of an object from the pool
(pool-party/with-object pool uuid
  (println (str "borrowing obj: " uuid))))
```
...
Copyright © 2023 Enraged Ginger LLC w/ contributions from Gateless.
